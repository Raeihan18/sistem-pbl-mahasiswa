...
<div class="d-flex align-items-center mb-3">
    ...
    <a href="/pembimbing/nilai-mahasiswa/create" class="btn btn-primary me-2">
        <i class="fas fa-plus"></i> Tambah Nilai Mahasiswa
    </a>

    <a href="/pembimbing/nilai-mahasiswa/export" class="btn btn-success me-3">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($listNilai as $nl)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="/pembimbing/nilai-mahasiswa/edit/{{ $nl->id_nilai_mahasiswa }}"
                                                               class="btn btn-warning btn-sm">✏️ Edit</a>

                                                            <a href="/pembimbing/nilai-mahasiswa/delete/{{ $nl->id_nilai_mahasiswa }}"
