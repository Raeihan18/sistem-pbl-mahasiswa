...
class ControllerNilaiKelompokAdmin extends Controller
{
...
// dd($request);   
    ...
    $title = "Nilai Kelompok";
    return view('admin.nilai-kelompok.index', compact('mataKuliah', 'nilaiKelompok', 'title'));
}
...
// Generate nilai kelompok dari nilai mahasiswa
    public function generateNilaiKelompok($id_matkul)
    {
        ...
        return redirect()->route('admin.nilai-kelompok.index', ['id_matkul' => $id_matkul])
